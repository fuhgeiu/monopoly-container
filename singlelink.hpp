...
namespace node_container {
    ...
    namespace single {
        ...
        public:
            ...
            circular_list () : head(nullptr) {}

            circular_list(const circular_list<T>& cpy_from) {
            ...
            T ret_value_index (size_t index) {
                ...
                for (size_t i = 0; i < (index-1); i++) {
                    ...
                    if (temp == nullptr) throw std::runtime_error("index out of bounds   segmentation fault\n");
            ...
            node<T>* first_cpy_ret () {if (head != nullptr) return head; else throw std::runtime_error("no data");}               // assignable
            ...
            void add (const T& data) {
                ...
                if (head == nullptr) {this->head = new node<T> (data); head->next = head;}
            }
